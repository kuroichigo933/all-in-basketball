...
The first 84 seconds of the local mixed recording contain 30 crossover, 19 between-the-legs, and 22 behind-the-back labels. All five segments and both inference repeats are calibration data because tracker and threshold choices used this source. Adaptive focused detector fallback raised learned-candidate frame coverage to 0.854438-0.860355. Across controlled and mixed sources, color-neutral appearance plus move-constrained dynamics tuning raises promoted ball F1 to 0.772152-0.777070; move F1 is 0.536170-0.538462. Neither approaches 95%. The rolling detector still cannot reliably count all rapid half-second sequences while ball identity varies.
