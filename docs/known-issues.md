...
- EfficientDet's generic `sports ball` class can miss a small, blurred, black, or occluded basketball. Color-independent motion candidates and tap-to-lock improve acquisition, but a ball moving against a similarly moving/low-contrast background can still be ambiguous.
