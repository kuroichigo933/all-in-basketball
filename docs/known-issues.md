...
- The representative calibration schedule is complete at 60 independently labeled frames: 56 visible and four fully occluded. Current tracked and raw identity F1 are both 0.428571 (24/56 localized). All four occlusion frames followed measured distractors and none used valid prediction persistence. Disabling distant color and motion challengers did not help because in-gate body candidates remained trajectory-coherent; appearance evidence is required. The slice contains no true absent-ball frames, black-ball footage, varied players, or hard no-ball distractors.
...
- The mixed 84-second calibration source adds 23 visible ball boxes, one absent frame, and one occlusion. One visibly misplaced box was corrected after adjacent-frame review. Two runs of the latest player-gated defaults produce tracked F1 0.695652-0.739130 and raw F1 0.711111-0.755556. The absent frame still has raw candidates but remains a true negative because no reliable player pose is present. Candidate-oracle recall is 0.956522 in both latest runs, so association remains limiting.
...
- The mixed calibration source covers crossover but is not holdout data. Promoted live defaults reach move F1 0.519084-0.558140; a repeat-calibrated saved configuration reaches 0.551181-0.569106 but is not promoted because its tighter pose thresholds regress the older cohort. No release gate is unblocked.
